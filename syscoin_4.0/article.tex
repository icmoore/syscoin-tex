...
\begin{abstract}
Syscoin 4.0 introduces a novel implementation of a decentralized identity, zero-knowledge proofs, masternodes providing bonded validators for a PoW/PoS hybrid consensus model (Nakamoto DAG) and instant pseudo-interactive zero-confirmation cryptocurrency transactions with double-spend protection.
\end{abstract}
...
\subsection{Syscoin's Vision and Value Proposition}
